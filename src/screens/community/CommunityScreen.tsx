...
export default function CommunityScreen() {
  ...
  useFocusEffect(
    useCallback(() => {
      getBoardPosts({ boardType: 'general', limit: 3 })
        .then(res => setGeneralPosts(res.posts.slice(0, 3)))
        .catch(() => {});
      getBoardPosts({ boardType: 'free', limit: 3 })
        .then(res => setFreePosts(res.posts.slice(0, 3)))
        .catch(() => {});
      getNotifications()
            ...
            {generalPosts.length > 0 && (
              ...
              >
                ...
                <Image
                  ...
                  style={{ width: 3, height: 6, marginLeft: 7 }}
                />
              </TouchableOpacity>
            )}
          </View>
